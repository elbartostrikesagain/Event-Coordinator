...
describe MainEventsController do
  ...
  describe "GET index" do
    it "assigns all main_events as @main_events" do
      main_event = MainEvent.create! valid_attributes
  ...
  describe "GET show" do
    it "assigns the requested main_event as @main_event" do
      main_event = MainEvent.create! valid_attributes
      get :show, {:id => main_event.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested main_event as @main_event" do
      main_event = MainEvent.create! valid_attributes
      get :edit, {:id => main_event.to_param}, valid_session
      assigns(:main_event).should eq(main_event)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new MainEvent" do
        expect {
          post :create, {:main_event => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved main_event as @main_event" do
        ...
        post :create, {:main_event => {}}, valid_session
        assigns(:main_event).should be_a_new(MainEvent)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested main_event" do
        ...
        put :update, {:id => main_event.to_param, :main_event => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested main_event as @main_event" do
        main_event = MainEvent.create! valid_attributes
        put :update, {:id => main_event.to_param, :main_event => valid_attributes}, valid_session
        assigns(:main_event).should eq(main_event)
      end
    ...
    describe "with invalid params" do
      it "assigns the main_event as @main_event" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        MainEvent.any_instance.stub(:save).and_return(false)
        put :update, {:id => main_event.to_param, :main_event => {}}, valid_session
        assigns(:main_event).should eq(main_event)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested main_event" do
      main_event = MainEvent.create! valid_attributes
      expect {
        delete :destroy, {:id => main_event.to_param}, valid_session
      }.to change(MainEvent, :count).by(-1)
    end
